$(document).ready(function(){
    ...
    function putUserEntryInEventObject(){ //Rewrite to interact with greeter page
        ...
        var userEvent = {
            ...
            eventStartTime: convertStringToUnixTime($("#startTime-input").val()),
            eventEndTime: convertStringToUnixTime($("#endTime-input").val()),
            eventAdded:convertStringToUnixTime(Date.now()),
